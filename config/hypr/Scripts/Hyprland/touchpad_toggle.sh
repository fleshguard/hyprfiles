...
state_file="/home/spacerat/.config/hypr/Scripts/Logs/touchpad_state_file"
...
main() {
  ...
  if [[ "$current_state" == "true" ]]; then
      hyprctl keyword device[asuf1204:00-2808:0202-touchpad]:disable_while_typing false
          notify-send -i /usr/share/icons/breeze-dark/status/32/touchpad_enabled.svg -t 2500 -h boolean:transient:true \
      ...
      hyprctl keyword device[asuf1204:00-2808:0202-touchpad]:disable_while_typing true
          notify-send -i /usr/share/icons/breeze-dark/status/32/touchpad_disabled.svg -t 2500 -h boolean:transient:true \
